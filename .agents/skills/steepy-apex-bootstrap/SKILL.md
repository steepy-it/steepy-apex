---
name: steepy-apex-bootstrap
description: Project entry point for steepy-apex. Loads the root instructions and routes work through the governed hub.
user-invocable: true
---
<!-- steepy:generated:steepy-apex-bootstrap:v1 -->

# steepy-apex bootstrap
